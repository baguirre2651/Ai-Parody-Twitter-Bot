...
# Loads Twitter and Airtable API keys (preferably from environment variables, config file, or within the railyway app)
...
# Remember state in each of these runs, bot will wake up and check for mentions that it has, using an Air table data bas.
